...
Bark is still a work in progress and as of this latest update to this repo, it can now perform integer operations, boolean checks, prefix operators, nested conditionals, and return statements via the REPL. More is coming soon though!
